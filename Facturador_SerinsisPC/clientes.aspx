                ...
                <asp:Repeater runat="server" ID="rpClientes">           
                    <ItemTemplate>
                        <tr class="row-100">
                            ...
                            <td class="col-auto"><%# Eval("estado") %>
                                <asp:LinkButton runat="server" ID="btnEstado" OnClick="btnEstado_Click"   CommandArgument='<%# Eval("id") %>'><i class="fas fa-check-double"></i></asp:LinkButton>
                            </td>
                            <td class="col-1">
